...
export const reducer = createReducer(initialState,
    ...
    on(ViewerActions.more, state => ({ ...state, showWizard: false })),
    on(ViewerActions.stopRecord, state => ({ ...state, showWizard: false })),
    on(ViewerActions.dismissWizard, state => ({ ...state, showWizard: false })),
    );
